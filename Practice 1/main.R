...
regl_lowess = lowess(x=reduced_data$F635_B635, y=reduced_data$F532_B532)
F532_P = reduced_data$F532_B532 * ( regl_lowess[[1]]/regl_lowess[[2]] )
...
plot(y=M_Cy5Cy3, x=A_Cy5Cy3)
abline(regl)
MA_lowess = lowess(y=M_Cy5Cy3, x=A_Cy5Cy3)
par(new=TRUE)
plot(x=MA_lowess[[1]],y=MA_lowess[[2]], col='red', type='l')
...
par(new=TRUE)
plot(x=regl_curve[[1]], y=regl_curve[[2]], type='l', col='red')
